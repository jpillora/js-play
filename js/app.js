...
(function() {
  ...
  App.controller('Controls', function($rootScope, $scope, $window, ace, gh, runner, storage) {
    ...
    return ace.handler('key', function(key, e) {
  ...
  App.factory('ace', function($rootScope, storage) {
    var Range, editor, handlers, scope, session;
    ...
    scope.set(storage.get('ace-current-code') || "console.log('hello world!');");
    editor.on('change', function() {
      return storage.set('ace-current-code', scope.get());
    });
    return scope;
  });
